...
project "Shadow3D"
    ...
    targetdir(path.join("E:/Programming/ScarletProjects/Shadow3D/", "Scratch/Bin/", "%{prj.name}"))
    objdir(path.join("E:/Programming/ScarletProjects/Shadow3D/", "Scratch/Bin-Int/", "%{prj.name}"))
